...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\GatewayInterface' => \App\Gateways\SmsGateway::class,
            'App\Contracts\NotificationRepositoryInterface' => \App\Repositories\NotificationRepository::class,
    ...
    override(\config(), map([
            ...
            'queue.connections.rabbitmq.options.queue.prioritize_later' => 'boolean',
            ...
            'services.gateways.sms' => 'string',
            'services.gateways.email' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./www/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'queue.connections.deferred.driver','queue.connections.failover.driver','queue.connections.failover.connections','queue.connections.background.driver','queue.connections.rabbitmq.driver',
...
'queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost','queue.connections.rabbitmq.options.ssl_options.cafile','queue.connections.rabbitmq.options.ssl_options.local_cert','queue.connections.rabbitmq.options.ssl_options.local_key',
'queue.connections.rabbitmq.options.ssl_options.verify_peer','queue.connections.rabbitmq.options.ssl_options.passphrase','queue.connections.rabbitmq.options.queue.prioritize_later','queue.connections.rabbitmq.worker','queue.batching.database',
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','self-diagnosis.environment_aliases.prod',
'self-diagnosis.environment_aliases.live','self-diagnosis.environment_aliases.local','self-diagnosis.checks','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DatabaseCanBeAccessed.default_connection','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DatabaseCanBeAccessed.connections',
'self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DirectoriesHaveCorrectPermissions.directories','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreInstalled.extensions','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreInstalled.include_composer_extensions','self-diagnosis.checks.Tests\\Checks\\RedisCanBeAccessed.default_connection','self-diagnosis.checks.Tests\\Checks\\RedisCanBeAccessed.connections',
'self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.programs','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.restarted_within','self-diagnosis.environment_checks.development','self-diagnosis.environment_checks.production','self-diagnosis.environment_checks.production.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreDisabled.extensions',
'services.postmark.key','services.resend.key','services.ses.key','services.ses.secret','services.ses.region',
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.gateways.sms','services.gateways.email','session.driver',
...
'horizon::layout','l5-swagger::index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'SESSION_DOMAIN','RABBITMQ_HOST','RABBITMQ_PORT','BROADCAST_CONNECTION','FILESYSTEM_DISK',
